          ...
          <ul class="p-single__lists">
            <li class="p-single__list">
              <?php if (get_previous_post()) : ?>
                <a href="<?php echo get_permalink(get_previous_post()); ?>" class="p-single__prev">
            ...
            <li class="p-single__list">
              <?php if (get_next_post()) : ?>
                <a href="<?php echo get_permalink(get_next_post()); ?>" class="p-single__next">
                  <p class="p-single__next-text">
                    next
                  </p>
                  <svg xmlns="http://www.w3.org/2000/svg" width="5" height="7.809" viewBox="0 0 5 7.809">
