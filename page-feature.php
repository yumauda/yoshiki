            ...
            <ul class="p-block__lists">
              <li class="p-block__list js-feature-cards">
                ...
                <div class="p-block__detail">
                  <p class="p-block__detail-title">競争意識が芽生える</p>
                  <p class="p-block__explain">
                    友達と競い合いながら勉強することは、互いに良い刺激を与え合うことにつながります。「友達が頑張っているから自分も頑張ろう」といった感情が芽生え、集中力や学力の向上が期待できます。
                  </p>
                </div>
              </li>
              <li class="p-block__list js-feature-cards">
                ...
                <div class="p-block__detail">
                  <p class="p-block__detail-title">メリハリのついた楽しく学べる授業</p>
                  <p class="p-block__explain">
                    塾である以上、メインは勉強を教えることです。しかし、服部塾・よしき塾はコミュニケーションを取りながら進めるスタイルの塾です。一方的に説明するだけの授業は行いません。集中して真面目に学ぶ時間をしっかり確保します。ときには、冗談を言ったり面白い覚え方で盛り上がったりすることもあります。<br>
                    生徒の様子を見ながら、メリハリをつけているため集団授業ならではの楽しく学べる雰囲気があります。
                  </p>
                </div>
              </li>
              <li class="p-block__list js-feature-cards">
                ...
                <div class="p-point__content">
                  <div class="p-point__row js-consistent">
                    ...
                    <div class="p-point__detail">
                      <p class="p-point__text">生徒はもちろん、保護者の方にとっても、学年が上がってもそのまま同じ先生の指導が受けられる安心感は大きいものです。<br>
