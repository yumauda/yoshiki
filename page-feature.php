            ...
            <ul class="p-block__lists">
              ...
              <li class="p-block__list js-feature-cards">
                ...
                <div class="p-block__detail">
                  ...
                  <p class="p-block__explain">
                    塾である以上、メインは勉強を教えることです。しかし、服部塾・よしき塾はコミュニケーションを取りながら進めるスタイルの塾です。一方的に説明するだけの授業は行いません。集中して真面目に学ぶ時間をしっかり確保します。ときには、冗談を言ったり面白い覚え方で盛り上がったりすることもあります。生徒の様子を見ながら、メリハリをつけているため集団授業ならではの楽しく学べる雰囲気があります。
                  </p>
                </div>
              </li>
              <li class="p-block__list js-feature-cards">
